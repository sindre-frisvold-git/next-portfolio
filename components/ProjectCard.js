...
export default function ProjectCard({ title, tech }) {
  return (
    // <Link>
    <div className="h-60 w-full relative rounded-md my-1 md:w-60 bg-red-100 dark:bg-gray-700 overflow-hidden scroll-mt-9 mt-9 mb-9 snap-child cursor-ns-resize">
