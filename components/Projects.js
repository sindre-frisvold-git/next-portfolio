  ...
  return (
    <div className="md:flex justify-center md:w-3/4 ">
      <div
        ...
        ref={projectScroll}
        className="overflow-y-scroll max-h-96 md:max-h-[36rem]  md:w-full md:max-w-xl snap-parent scroll-smooth transparent-scroll border-x-2 border-solid border-gray-800 dark:border-slate-100 px-4"
